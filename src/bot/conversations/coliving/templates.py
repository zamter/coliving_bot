...
ERR_PHOTO_NOT_TEXT = "Отправь до 5 фотографий своего жилья."
...
REPLY_BTN_HIDE = (
    ...
    "\n"
    "Анкета скрыта из поиска. "
    "Не забудь открыть анкету позже, "
    "чтобы найти соседей."
)
REPLY_BTN_SHOW = "Твой ответ: Показать в поиске" "\n" "\n" "Анкета доступна для поиска."
REPLY_MSG_ASK_ROOM_TYPE = "Выбери тип предоставляемого жилья:"
REPLY_MSG_ASK_ABOUT = (
    "Расскажи о своём жилье." "\n" "Краткое описание коливинга и его жильцов:"
)
REPLY_MSG_ASK_PRICE = "Укажи цену аренды за месяц:"
REPLY_MSG_ASK_PHOTO_SEND = (
    "Теперь можешь отправить фото квартиры." "\n" "Загрузи до 5 фотографий:"
)
REPLY_MSG_PHOTO = (
